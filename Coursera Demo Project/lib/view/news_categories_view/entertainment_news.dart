...
class _EntertainmentNews extends State<EntertainmentNews> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<EntertainmentHeadlines>(future: getApiResponse.fetchEntertainmentHeadlines(),
          builder: (context, AsyncSnapshot<EntertainmentHeadlines> snapshot){
            if(!snapshot.hasData){
              return Center(
                child: Padding(
